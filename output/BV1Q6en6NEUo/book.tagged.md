...
1. [Lab1：会成长的个人助手](#1-lab1)
2. [项目、Intent 与可追踪性](#2-intent)
3. [Git 深潜：Merge、Rebase 与 Change](#3-git)
4. [Jujutsu：把 Change 变成一等公民](#4-jj)
5. [为 Agent 重新设计版本管理](#5-agent)
6. [从第一性原理看并发控制](#6)
7. [团队管理才是真正的难点](#7)
8. [现场翻车：Vibe Coding 从零做 Lab1](#8-vibe-coding)
9. [MVP 与可演进架构](#9-mvp)
10. [结语：版本管理要记住的三件事](#10)
...
![Lab1：会成长的个人助手需求](SCREENSHOT:00:00:30)
...
![项目中的 Traceability 问题](SCREENSHOT:00:09:50)
...
![Jujutsu：Change 作为一等公民](SCREENSHOT:00:31:00)
...
![多 Agent 并行：tmux + worktree](SCREENSHOT:00:47:00)
...
![单向汉诺塔可视化 Playground](SCREENSHOT:01:11:40)
...
![直接把 Lab 需求丢给 Agent](SCREENSHOT:01:20:10)
...
![需求变更：引入云盘同步](SCREENSHOT:01:36:10)
...
*由 VideoBook 流水线生成 · 内容衍生自 B 站公开课程视频 BV1Q6en6NEUo*
